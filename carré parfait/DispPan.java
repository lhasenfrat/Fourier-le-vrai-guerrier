...
public class DispPan extends JPanel implements ActionListener{
	...
	public void paint(Graphics g){
		...
		point1 = new Complexe(this.getWidth()/2 + (int)(dessin.getFirst().getRe()/16384), this.getHeight()/2 + (int)(dessin.getFirst().getIm()/16384));
		g.setColor(Color.red);
		for(Complexe c : dessin){
			g.drawLine((int)(point1.getRe()), (int)(point1.getIm()), (int)(c.getRe()/16384 + this.getWidth()/2), (int)(c.getIm()/16384) + this.getHeight()/2);
			point1 = new Complexe(c.getRe()/16384 + this.getWidth()/2, c.getIm()/16384 + this.getHeight()/2);
		}
